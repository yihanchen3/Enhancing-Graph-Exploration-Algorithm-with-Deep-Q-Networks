...
class AgentNet(nn.Module):
    ...
    def forward(self, x: torch.Tensor, edge_index: torch.Tensor, batch: torch.Tensor, edge_feat: Optional[torch.Tensor] = None,  cycle: Optional[torch.Tensor] = None, node_with_most_edge: Optional[torch.Tensor] = None):
        ...
        for i in range(self.num_steps+1):
            ...
            if i > 0: 
                ...
                reward[cycle[agent_pos] == 1] += 1.0
                reward[node_with_most_edge[agent_pos] == 1] += 1.0
